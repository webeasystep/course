...
# 2- add new directory with the name (assets) and put 10 images on it (jpg,png,gif)
#   add another direction with the name (uploaded_images) and keep it empty

# 3- change import_quotes name to be (upload_images) and functionality like following :
